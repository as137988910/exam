                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <div class="toolbar-btn-action">
                                    <a class="btn btn-primary m-r-5" href="#!" onclick="saveStudent()"><i class="mdi mdi-plus"></i> 新增</a>
                                </div>
                            </div>
                            <div class="card-body">
...
<div id="pop-box">
    <div class="layui-layer-shade" id="layui-layer-shade1"
        ...
        <div class="layui-layer layui-layer-iframe" id="layui-layer1" type="iframe" times="1" showtime="0" contype="string"
            ...
            <form onsubmit="return false" class="center-block"id="student-form" >
                <input type="text" hidden name="id" id="uid">
                ...
                <div class="form-group">
                    <button class="btn btn-primary center-block" onclick="saveStudentInfo()">保存</button>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
            ...
            success: function (data) {
                ...
                for (let i = 0; i < data.length; i++) {
                    ...
                    tr.innerHTML = "\n" +
                        ...
                        "                                            <td>\n" +
                        "                                                <div class=\"btn-group\">\n" +
                        "                                                    <a class=\"btn btn-xs btn-default\" href=\"#!\" title=\"编辑\" data-toggle=\"tooltip\" onclick='updateStudent(this)'><i class=\"mdi mdi-pencil\"></i></a>\n" +
                        "                                                    <a class=\"btn btn-xs btn-default\" href=\"#!\" title=\"删除\" data-toggle=\"tooltip\" onclick='deleteStudent("+data[i].id+")'><i class=\"mdi mdi-window-close\"></i></a>\n" +
                        "                                                </div>\n" +
                        "                                            </td>"
                        "                                        </tr>";
    ...
    var controlFlag;
    function updateStudent(th){
        var parent=th.parentNode.parentNode.parentNode;
        document.getElementById('uid').value=parseInt(parent.childNodes[1].innerText);
    ...
    function deleteStudent(id) {
        $.ajax({
            url:'/api/admin/deleteUser?id='+id,
            type:"DELETE",
            success:function (data) {
                console.log(data)
            }
